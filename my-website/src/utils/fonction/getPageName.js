...
function getPageName(lang) {
    ...
    if (string.includes("services") ) {
        ...
        let masqueFr = /^(index|contact|qui-suis-je|realisation|articles|site-web|seo|application-mobile)$/;
        let masqueEn = /^(home|contact|about|achievements|articles|website|seo|mobile-application)$/;
